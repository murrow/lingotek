...
use Drupal\lingotek\Plugin\RelatedEntitiesDetector\LinkItDetector;
use Drupal\Tests\UnitTestCase;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Unit test for the LinkIt entity detector plugin.
 *
 * @coversDefaultClass \Drupal\lingotek\Plugin\RelatedEntitiesDetector\LinkItDetector
 * @group lingotek
 * @preserve GlobalState disabled
 */
class LinkItDetectorTest extends UnitTestCase {

  /**
   * The class instance under test.
   *
   * @var \Drupal\lingotek\Plugin\RelatedEntitiesDetector\LinkItDetector
   */
  protected $detector;
  ...
  protected function setUp(): void {
    ...
    $this->detector = new LinkItDetector([], 'linkit_detector', [], $this->entityRepository, $this->entityFieldManager, $this->lingotekConfiguration);
  ...
  public function testConstruct() {
    $detector = new LinkItDetector([], 'linkit_detector', [], $this->entityRepository, $this->entityFieldManager, $this->lingotekConfiguration);
  ...
  public function testCreate() {
    ...
    $detector = LinkItDetector::create($container, [], 'linkit_detector', []);
    $this->assertNotNull($detector);
  }
  ...
  public function testRunExtract($fieldType, $hasSummary) {
    ...
    $data = [
      (object) [
        'value' => '<p>This is a text with a link <a data-entity-substitution="canonical" data-entity-type="the_first_type" data-entity-uuid="the-first-entity-uuid" href="/the_first_type/8">to a content</a> </p>',
      ],
      (object) [
        'value' => '<p>This is a text with a link <a data-entity-substitution="canonical" data-entity-type="entity_id" data-entity-uuid="the-second-entity-uuid" href="/entity_id/2">to a different content</a> </p>' .
        '<a data-entity-substitution="canonical" data-entity-type="third_entity_type" data-entity-uuid="the-third-entity-uuid" href="/entity_id/5">another link</a>',
      ],
    ];
    if ($hasSummary) {
      $data = [
        (object) [
          'value' => 'No link',
          'summary' => '<p>This is a text with a link <a data-entity-substitution="canonical" data-entity-type="the_first_type" data-entity-uuid="the-first-entity-uuid" href="/the_first_type/8">to a content</a> </p>',
        ],
        (object) [
          'value' => '<p>This is a text with a link <a data-entity-substitution="canonical" data-entity-type="entity_id" data-entity-uuid="the-second-entity-uuid" href="/entity_id/2">to a different content</a> </p>',
          'summary' => '<a data-entity-substitution="canonical" data-entity-type="third_entity_type" data-entity-uuid="the-third-entity-uuid" href="/entity_id/5">another link</a>',
        ],
      ];
    }
    $entity->expects($this->once())
