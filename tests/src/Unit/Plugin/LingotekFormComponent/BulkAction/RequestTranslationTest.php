...
use Drupal\lingotek\Plugin\LingotekFormComponent\BulkAction\RequestTranslation;
use Drupal\Tests\UnitTestCase;

/**
 * Unit test for the assign profile bulk action form component.
 *
 * @coversDefaultClass \Drupal\lingotek\Plugin\LingotekFormComponent\BulkAction\RequestTranslation
 * @group lingotek
 * @preserve GlobalState disabled
 */
class RequestTranslationTest extends UnitTestCase {

  /**
   * The class instance under test.
   *
   * @var \Drupal\lingotek\Plugin\LingotekFormComponent\BulkAction\RequestTranslation
   */
  protected $action;
  ...
  protected function setupAction($langcode = 'it') {
    $this->action = new RequestTranslation([], 'request_translation', [
  ...
  public function testExecuteSingleWithNoTranslatableContent() {
    ...
    $this->messenger->expects($this->once())
      ->method('addWarning')
      ->with($this->translation->translate('Cannot request @type %label translation for @language. That @bundle_label is not enabled for translation.', [
        '@type' => 'My Bundle',
        '%label' => 'My entity',
  ...
  public function testExecuteSingleWithNoTranslatableConfiguredContent() {
    ...
    $this->messenger->expects($this->once())
      ->method('addWarning')
      ->with($this->translation->translate('Cannot request @type %label translation for @language. That @bundle_label is not enabled for Lingotek translation.', [
        '@type' => 'My Bundle',
        '%label' => 'My entity',
        '@bundle_label' => 'My bundle label',
        '@language' => 'it',
