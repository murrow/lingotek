...
use Drupal\lingotek\Plugin\LingotekFormComponent\BulkAction\CheckTranslations;
use Drupal\Tests\UnitTestCase;

/**
 * Unit test for the assign profile bulk action form component.
 *
 * @coversDefaultClass \Drupal\lingotek\Plugin\LingotekFormComponent\BulkAction\CheckTranslations
 * @group lingotek
 * @preserve GlobalState disabled
 */
class CheckTranslationsTest extends UnitTestCase {
  ...
  protected function setupAction($langcode = 'it') {
    $this->action = new CheckTranslations([], 'check_translations', [
  ...
  public function testExecuteSingleWithNoTranslatableContent() {
    ...
    $this->messenger->expects($this->once())
      ->method('addWarning')
      ->with($this->translation->translate('Cannot check translations for @type %label. That @bundle_label is not enabled for translation.', [
        '@type' => 'My Bundle',
        '%label' => 'My entity',
  ...
  public function testExecuteSingleWithNoTranslatableConfiguredContent() {
    ...
    $this->messenger->expects($this->once())
      ->method('addWarning')
      ->with($this->translation->translate('Cannot check translations for @type %label. That @bundle_label is not enabled for Lingotek translation.', [
        '@type' => 'My Bundle',
        '%label' => 'My entity',
        '@bundle_label' => 'My bundle label',
      ]));
